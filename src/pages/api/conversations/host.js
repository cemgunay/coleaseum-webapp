    ...
    try {
        if (req.method === "POST") {
            ...
            if (isGroup) {
                ...
                // Convert each member's 'value' property to a MongoDB ObjectId and assign roles
                ...
                if (!memberIds.some((id) => id.equals(currentUser._id))) {
                    ...
                    userRoles.push({ userId: currentUserId, role: "tenant" });
            ...
            //if not push the default user roles with current user as tenant and other user as subtenant
            userRoles.push({ userId: currentUser._id, role: "tenant" });
            userRoles.push({
            ...
            if (newMembers && newMembers.length > 0) {
                ...
                // Optionally add default roles for new members
