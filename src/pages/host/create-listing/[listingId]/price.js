...
const Price = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const updateData = { price, priceChanged: true, utilities };
        ...
        >
            <div className="flex flex-col items-start gap-8 mx-8">
                ...
                <div className="w-full flex flex-col gap-4">
                    ...
                    <div>
                        Sublets like yours in your area usually range from $1000
                        to $1200. (based on location, amenities, nearby prices,
                        and demand)
                    </div>
                </div>
                <div className="w-full flex flex-col gap-4">
