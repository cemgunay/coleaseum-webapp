...
const Price = () => {
    ...
    const Loading = () => <Skeleton className="h-24 w-full mb-2" />;
    ...
    return (
        <CreateListingLayout
            ...
            canGoNext={canGoNext}
        >
            <div className="flex flex-col items-start gap-12 mx-8">
                <div className="flex items-center gap-2">
                    <div className="flex flex-col justify-between gap-2 w-3/4">
                        ...
                        <div className="font-light text-sm">
                            Finally, you'll set your monthly price and answer a
                        ...
                        {showDetails && (
                            <>
                                <div className="mt-2">
                                    ...
                                    <div>
                                        Sublet Fee: ${subletFee.toFixed(2)}
                                    </div>
                                    <div>Taxes: ${taxes.toFixed(2)}</div>
                                    <div>
                                        Guest Price: ${guestPrice.toFixed(2)}
                                    </div>
                                </div>
                                <div>You get: ${youGet.toFixed(2)}</div>
                                <div>5% coleaseum fee</div>
                            </>
                        )}
                    </div>
                )}
                ...
                <div>
                    Sublets like yours in your area usually range from $1000 to
                    $1200. (based on location, amenities, nearby prices, and
                    demand)
                </div>
